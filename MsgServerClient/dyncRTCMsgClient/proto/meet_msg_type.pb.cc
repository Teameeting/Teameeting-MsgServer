...
void protobuf_AddDesc_meet_5fmsg_5ftype_2eproto_impl() {
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_meet_5fmsg_5ftype_2eproto_once_);
void protobuf_AddDesc_meet_5fmsg_5ftype_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_meet_5fmsg_5ftype_2eproto_once_,
                 &protobuf_AddDesc_meet_5fmsg_5ftype_2eproto_impl);
}
#else
