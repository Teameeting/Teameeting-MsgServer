...
public:
    ...
    int EncodeGrpSyncSeqnNotify(std::string& outstr, const std::string& userid, const std::string& groupid, int module);
    int EncodeGrpSyncSeqnNotifys(std::string& outstr, const std::vector<std::string>& userids, const std::string& groupid,  int module);
