...
{   /* fAttrName, len, id */
    { "qtid",   (UInt32)strlen("qtid"),     eQtid   },
    { "qtver",  (UInt32)strlen("qtver"),    eQtver  },
    { "lang",   (UInt32)strlen("lang"),     eLang   },
    { "os",     (UInt32)strlen("os"),       eOs     },
    { "osver",  (UInt32)strlen("osver"),    eOsver  },
    { "cpu",    (UInt32)strlen("cpu"),      eCpu    }
};
