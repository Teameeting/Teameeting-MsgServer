...
#ifndef __MsgServerStorage__SRTResponseCollection__
#define __MsgServerStorage__SRTResponseCollection__
...
public:
    ...
    class MsgSeqn {
        ...
        //<userid, msgid, seqn>
        //sigslot::signal3<const std::string&, const std::string&, long long> StorageResponse;
        //<userid, pms::SeqnMsg
        //sigslot::signal2<const std::string&, const std::string&> StorageResponse;
        //pms::SeqnMsg
        sigslot::signal1<const std::string&> StorageResponse;
        bool AddAndCheckResp(long long seq)
        {
            ...
            if ((++counter) == cnumber)
            {
                ...
                StorageResponse(msg.SerializeAsString());
                //for(auto x : seqns)
                //{
                //     printf("seqn is:%lld\n", x);
                //}
...
#endif /* defined(__MsgServerStorage__SRTResponseCollection__) */
