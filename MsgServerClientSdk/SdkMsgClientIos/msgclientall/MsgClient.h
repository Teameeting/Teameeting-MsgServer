...
public:
    ...
    int MCGetMsg(int tag);
    
    int MCOptRoom(int tag, const std::string& roomid, const std::string& rname, const std::string& remain);
    int MCSndMsgTo(const std::string& roomid, const std::string& rname, const std::string& msg, const std::vector<std::string>& vlist);
    
    int MCNotifyMsg(const std::string& roomid, const std::string& rname, int tag, const std::string& msg);
