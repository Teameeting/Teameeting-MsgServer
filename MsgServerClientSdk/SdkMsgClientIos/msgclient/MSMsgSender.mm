...
{
    if (msgClient) {
        return msgClient->MCOptRoom(tag, [roomid UTF8String], [rname UTF8String], [remain UTF8String]);
    } else {
        return -1;
    }
}
...
{
    if (msgClient) {
        return msgClient->MCNotifyMsg([roomid UTF8String], [rname UTF8String], tag, [msg UTF8String]);
    } else {
        return -1;
    }
}
