...
GPBEnumDescriptor *EServerCmd_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "ting\000Csynconedata\000Csynconegroupdata\000Coth"
        "erlogin\000";
    static const int32_t values[] = {
        ...
        EServerCmd_Csynconedata,
        EServerCmd_Csynconegroupdata,
        EServerCmd_Cotherlogin,
    };
...
BOOL EServerCmd_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case EServerCmd_Csynconedata:
    case EServerCmd_Csynconegroupdata:
    case EServerCmd_Cotherlogin:
      return YES;
    default:
      return NO;
  }
