...
public class JMClientApp {
    ...
    public native int CreateRoom(String strUserid, String strPass, String strRoomid);
    public native int EnterRoom(String strUserid, String strPass, String strRoomid);
    public native int LeaveRoom(String strUserid, String strPass, String strRoomid);
    public native int DestroyRoom(String strUserid, String strPass, String strRoomid);
