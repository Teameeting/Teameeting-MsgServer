package org.dync.teameeting.demo;
                ...
                if (messagetype== JMClientType.MCMESSAGETYPE_REQUEST) {
                    switch(tags) {
                        ...
                        case JMClientType.MCSENDTAGS_LEAVE:
                            ...
                            break;
                        case JMClientType.MCSENDTAGS_SUBSCRIBE:
                            content = "MCSENDTAGS_SUBSCRIBEK: " + cont;
                            break;
                        case JMClientType.MCSENDTAGS_UNSUBSCRIBE:
                            content = "MCSENDTAGS_UNSUBSCRIBE: " + cont;
                            break;
                    }
                }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnnotify:
            {
                ...
                mMsgSender.TMNotifyMsg(mRoomid, mRname, JMClientType.MCSENDTAGS_SUBSCRIBE, mNotifyMsg);
                try {
                    Thread.sleep(1);
                } catch  (Exception e) {
