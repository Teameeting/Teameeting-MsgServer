...
import com.dync.teameeting.msgserverclient.jni.JMClientApp;
import com.dync.teameeting.msgserverclient.jni.JMClientHelper;
import com.dync.teameeting.msgserverclient.jni.NativeContextRegistry;
import com.dync.teameeting.msgserverclient.util.MsgUtils;
...
public abstract class MsgClient implements JMClientHelper{
    ...
    protected int MCCreateRoom(String strUserid, String strPass, String strRoomid) {
        if (null != mMApp) {
            return mMApp.CreateRoom(strUserid, strPass, strRoomid);
        } else {
            return -1;
        }
    }

    protected int MCEnterRoom(String strUserid, String strPass, String strRoomid) {
        if (null != mMApp) {
            return mMApp.EnterRoom(strUserid, strPass, strRoomid);
        } else {
            return -1;
        }
    }

    protected int MCLeaveRoom(String strUserid, String strPass, String strRoomid) {
        if (null != mMApp) {
            return mMApp.LeaveRoom(strUserid, strPass, strRoomid);
        } else {
            return -1;
        }
    }

    protected int MCDestroyRoom(String strUserid, String strPass, String strRoomid) {
        if (null != mMApp) {
            return mMApp.DestroyRoom(strUserid, strPass, strRoomid);
        } else {
            return -1;
        }
    }
